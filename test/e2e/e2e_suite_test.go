...
var (
	...
	projectImage = "example.com/signoz-alert-operator:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting signoz-alert-operator integration test suite\n")
...
var _ = BeforeSuite(func() {
	...
	By("loading the manager(Operator) image into k3d")
